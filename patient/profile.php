...
<body>
  <?php
    ...
    include("../include/connection.php");
        ...
        $query = "SELECT * FROM patients WHERE user='$patient' ";
          ...
          <div class="col-md-12">
            ...
            if(isset($_POST['upload'])){
              ...
              if(empty($img)){
                ...
                $query = "UPDATE patient SET profile_img='$img'WHERE user='$patient'";
                $res = mysqli_query($connect,$query);
                if($res){
            ...
            ?>
                <h5 class="my-2"><?php echo $row['user'];?> Profile</h5>
            ...
            if(isset($_POST['update'])){
              ...
              if(empty($uname)){
                ...
                $query = "UPDATE patient SET user ='$uname' WHERE user='$patient'";
                  $res = mysqli_query($connect,$query);
                  if($res){
                          ...
                          if(isset($_POST['change'])){
                            ...
                            $row = mysqli_fetch_array($ols);
                              if($old != $row['password']){
                                ...
                                $query = "UPDATE patient SET password='$new'WHERE user='$patient'";
