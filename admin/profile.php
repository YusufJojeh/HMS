          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-6 mx-2">
                <h4 class="my-3 fw-bold"><?php echo"$username";  ?> Profile</h4>
                <?php
                  if(isset($_POST['update'])){
                    $profile = $_FILES['profile_img']['name'];
                    if(empty($profile)){}
                    else{
                      $query = "UPDATE admin SET profile_img ='$profile' WHERE user ='$ad'";
              ...
              <div class="col-md-5">
                ...
                <?php
                      if(isset($_POST['change'])){
                        ...
                        if(empty($uname)){
                          ...
                          $query = "UPDATE admin SET user='$uname' WHERE user ='$ad'";
                          $res = mysqli_query($connect,$query);
                ...
                <?php
                      ...
                      $old = mysqli_query($connect,"SELECT * FROM admin WHERE user = '$ad'");
                      ...
                      if(empty($old_pass)){
                        ...
                        if(count($error)==0){
                        $query = "UPDATE admin SET password = '$new_pass' WHERE user ='$ad'";
                        $res = mysqli_query($connect,$query);
                        if($res){
